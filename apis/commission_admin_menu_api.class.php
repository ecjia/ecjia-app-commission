...
class commission_admin_menu_api extends Component_Event_Api {
	...
	public function call(&$options) {
		...
		$submenus = array(
			...
			ecjia_admin::make_admin_menu('02_commission_list', __('结算账单'), RC_Uri::url('commission/admin/init'), 2)->add_purview('commission_manage'),
		    ecjia_admin::make_admin_menu('03_commission_list_day', __('每日账单'), RC_Uri::url('commission/admin/day'), 3)->add_purview('commission_day_manage'), 
