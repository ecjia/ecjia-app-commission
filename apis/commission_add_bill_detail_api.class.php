...
class commission_add_bill_detail_api extends Component_Event_Api {
    ...
    public function call(&$options) {
        if (!is_array($options) || !isset($options['store_id']) || !isset($options['order_type']) || !in_array($options['order_type'], array(1,2))
            || !isset($options['order_id']) || !isset($options['order_amount'])) {
