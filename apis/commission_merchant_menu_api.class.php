...
class commission_merchant_menu_api extends Component_Event_Api {
	...
	public function call(&$options) {
		...
		$submenus = array(
			...
			ecjia_merchant::make_admin_menu('04_commission_detail', __('分成明细', 'commission'), RC_Uri::url('commission/merchant/record'), 4)->add_purview('commission_order')->add_icon('fa-list-alt'), // order_view
		);
