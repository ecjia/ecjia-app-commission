...
class commission_merchant_menu_api extends Component_Event_Api {
	...
	public function call(&$options) {
		...
		$menus = ecjia_merchant::make_admin_menu('07_commission', __('财务', 'commission'), '', 7)->add_icon('fa-money')->add_purview(array('commission_manage', 'commission_month','commission_day','commission_order','commission_count'))->add_base('commission');
		...
		$submenus = array(
            ...
            ecjia_merchant::make_admin_menu('04_commission_detail', __('分成明细', 'commission'), RC_Uri::url('commission/merchant/affiliate'), 5)->add_purview('commission_affiliate')->add_icon('fa-list-alt'), // order_view
		);
